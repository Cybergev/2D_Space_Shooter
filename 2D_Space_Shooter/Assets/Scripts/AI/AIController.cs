...
namespace SpaceShooter
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        private Destructible ActionCheeckTarget(GameObject v_gameObject)
        {
            Destructible target = v_gameObject.transform.root.GetComponent<Destructible>();

            if (target != null && target.TeamId != Destructible.TeamIdNeutral && target.TeamId != m_SpaceShip.TeamId)
            {
                return target;
            }
            else
